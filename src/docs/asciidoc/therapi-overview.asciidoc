...
JSON-RPC is a standard protocol for making remote procedure calls. The client makes a request to the server
by building a JSON object specifying the method name and arguments. The server returns a JSON object containing
